...
parser.add_argument('--trainroot', help='path to dataset', default='./tool/train/')
...
parser.add_argument('--crnn', default='./expr_1/netCRNN_19_2486.pth', help="path to crnn (to continue training)")
