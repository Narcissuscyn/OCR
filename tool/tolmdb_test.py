...
def createDataset(outputPath, imagePathList, labelList, lexiconList=None, checkValid=True):
    ...
    for i in range(nSamples):
        ...
        imagePath = '/home/narcissus/file/dataset/ocr/test_hori_cut_res/' + labelList[i]
...
if __name__ == '__main__':
    outputPath = "./final_test_hori_sub"
    imgdata = open("/home/narcissus/file/dataset/ocr/test_hori_cut_nam_lst.txt",encoding='utf8')
